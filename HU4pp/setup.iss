#define GameName "Hunting Unlimited 4"
#define MyAppVersion "1.01"
#define MySetupFile "HU4pp"
#define InstIcon "pp4.ico"
#define UninstIcon "pp4u.ico"
#define HUexe "hu4.exe"
...
Source: "base\*"; DestDir: "{tmp}\pp4files"; Flags: recursesubdirs ignoreversion deleteafterinstall
...
[Run]
Filename: "{tmp}\7za.exe"; Parameters: "a -tzip -r0 -mx0 ""{code:GetHUPath}\base.scs"" .\pp4files\*"; StatusMsg: "Adding files to your {#GameName} game, please wait..."; Flags: runhidden
...
begin
  ...
  end else if RegQueryStringValue(HKCU, 'Software\ValuSoft\Hunting Unlimited 4', 'TargetPath', KeyValue) then begin
