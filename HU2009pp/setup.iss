#define GameName "Hunting Unlimited 2009"
#define MyAppVersion "1.01"
#define MySetupFile "HU2009pp"
#define InstIcon "pp2009.ico"
#define UninstIcon "pp2009u.ico"
#define HUexe "hu2009.exe"
...
Source: "base\*"; DestDir: "{tmp}\pp09files"; Flags: recursesubdirs ignoreversion deleteafterinstall
...
[Run]
Filename: "{tmp}\7za.exe"; Parameters: "a -tzip -r0 -mx0 ""{code:GetHUPath}\base.scs"" .\pp09files\*"; StatusMsg: "Adding files to your {#GameName} game, please wait..."; Flags: runhidden
...
begin
  ...
  end else if RegQueryStringValue(HKCU, 'Software\ValuSoft\Hunting Unlimited 2009', 'TargetPath', KeyValue) then begin
